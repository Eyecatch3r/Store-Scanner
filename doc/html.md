...
<script src="Touch-Scanner/js/vendor/modernizr-3.10.0.min.js"></script>
<script src="https://polyfill.io/v3/polyfill.min.js"></script>
<script src="Touch-Scanner/js/plugins.js"></script>
<script src="Touch-Scanner/js/main.js"></script>
</body>
```
