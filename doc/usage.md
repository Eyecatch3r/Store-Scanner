...
table of contents](Touch-Scanner/doc/TOC.md)
...
get you started. [About the JavaScript](Touch-Scanner/doc/js.md).
...
[Read more about the `.editorconfig` file](Touch-Scanner/doc/misc.md#editorconfig).
...
refer to the [according documentation](Touch-Scanner/doc/extend.md#apple-touch-icons).
